...
var twitterUsername      = "divielicious";
...
var flickrUsername       = "neilkrug";
var flickrPer_Page       = 5;
var flickrAPI_KEY        = "10cee2b1b70b15b9dbdbd8771d1e7c80";
...
var pinterestUsername    = "krystlekouture";
var pinterestPer_Page    = 10;
var pinterestDescLimit   = 80;
var pinterestProfileName = "Baking Beauty";
var pinterestProfileDesc = "baking beauty";
var pinterestProfileWebS = "http://www.pinterest.com/krystlekouture/";
...
var tumblrUsername       = "mylifesayings.tumblr.com";
var tumblrPer_Page       = 5;
var tumblrTrim           = 100;
var tumblrTitleTrim      = 60;
var tumblrAPI_KEY        = "uirgAX3qDipF07JhLyPjEjfw9HIhqlttqfTsuZ1UwhzOZrmLZ5";    //http://www.tumblr.com/oauth/apps
...
var youtubeChannelName   = "KatyPerryVEVO";
...
var vimeoConsumerKey     = "670bcebabf138919111c48231132af9a0aa98716";
var vimeoConsumerSecret  = "343133e01ca2c5647e6d91b4a36d35a37cdf721a";
var vimeoChannelName     = "photographyschool";
var vimeoPer_Page        = 5;
...
var behanceAPP_ID        = "X2vPVrxogqoddA5S9ltes96tw6aViYOB";
var behanceUsername      = "guyshield";
...
var pinterestContentBase        = "<div class='item itempinterest'><div class='pleft'><a class='fancybox-thumbs' href='%LINK%' data-fancybox-group='thumbpins' title='%TITLE%' target='_blank'><img class='avatar' src='%IMGSRC%'></a></div><div class='pright'><div class='title'><a href='http://www.pinterest.com%URL%' target='_blank'>%TITLE%</a></div><div>%DESC%</div></div>";
...
// ================================================ 
function twitter() {
    var url = "http://api.twitter.com/1/statuses/user_timeline.json?screen_name=" + twitterUsername + "&count=" + twitterPer_Page + "&callback=?";
...
function twitterMore() {
    ...
    var url         = "http://api.twitter.com/1/statuses/user_timeline.json?screen_name="+twitterUsername+"&count="+twitterPer_Page+"&page="+paged+"&callback=?"
    var tbase       = twitterContentBase;
...
function facebookProfile(){
    var url         = "http://graph.facebook.com/" + facebookPageName;
...
function flickr(userid) {
    ...
    var url         = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key="+flickrAPI_KEY+"&user_id="+flickrUsername+"&per_page="+flickrPer_Page+"&page=1&format=json";
...
function flickrMore() {
    ...
    var url         = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key="+flickrAPI_KEY+"&user_id="+flickrUsername+"&per_page="+flickrPer_Page+"&page="+paged+"&format=json";
...
function flickrUserID(){
    //var url         = "http://api.flickr.com/services/rest/?api_key="+flickrAPI_KEY+"&method=flickr.urls.lookupUser&format=json&nojsoncallback=1&url=http://www.flickr.com/photos/" + flickrUsername;
	
	var url = "https://api.flickr.com/services/rest/?method=flickr.urls.lookupUser&format=json&nojsoncallback=1&api_key="+flickrAPI_KEY+"&url=http://www.flickr.com/photos/"+flickrUsername; 
...
function flickrProfile(userid){
    var url         = "http://api.flickr.com/services/rest/?method=flickr.people.getInfo&api_key="+flickrAPI_KEY+"&user_id="+userid+"&format=json&nojsoncallback=1";
        ...
        success: function(data) { 
            ...
            $.each(data.body, function(key, value) {
                if (counter < pinterestPer_Page) {
                    ...
                    wcontent = wcontent.replaceAll('%TITLE%', value.board.name);
...
function tumblr() {
    ...
    var url         = "http://api.tumblr.com/v2/blog/"+tumblrUsername+"/posts/photo?limit="+tumblrPer_Page+"&offset=0&api_key="+tumblrAPI_KEY+"&notes_info=true";
    var avatar      = "http://api.tumblr.com/v2/blog/"+tumblrUsername+"/avatar";
...
function tumblrMore() {
    ...
    var url         = "http://api.tumblr.com/v2/blog/"+tumblrUsername+"/posts/photo?limit="+tumblrPer_Page+"&offset="+paged+"&api_key="+tumblrAPI_KEY+"&notes_info=true";
    var avatar      = "http://api.tumblr.com/v2/blog/"+tumblrUsername+"/avatar";
    var tbase       = tumblrContentBase;
