...
<article>
	...
	<?php if($LOGIN):?>
	<p>Exams may be password protected (the IT exam is). For exams that are password protected, the user will be directed to a screen that asks them to enter the password and confirm enrollment.</p>
	<?php endif; ?>
	<img src='images/training5.jpg'/>
	<p>Once successful password</p>
	<?php if($LOGIN): ?>	
	<p>Once they have entered the correct key, they will be taken to the exam screen:</p>
	<?php endif;?>
	<img src='images/training6.jpg'/>
	...
	<?php if($LOGIN):?>
	<p>Scores from the IT exam are displayed on completion and can be printed, and they are also logged in the training system.</p>
	<p>This exam is 30 multiple-choice questions. At this point, we're not going to implement a second exam. We'll assess fit for a specific role in the
