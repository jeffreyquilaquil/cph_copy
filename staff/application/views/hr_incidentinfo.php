...
<div>
	...
	<table class="tableInfo">
		...
		<tr>
			...
			<br>
			<a href="#">The answer can be found in employee.tatepublishing.net</a><br><br>
			<a href="#">Send custom resolution response</a><br><br>
			<a href="#">This is not an HR inquiry, Redirect to another department</a><br><br>
			<!-- APPEAR ONLY IF HR STAFF SELECT YES TO INVESTIGATION REQUIRED ITEM REMOVE -->
			<div id="appear_furtherinfo">
				<a href="#">Further information (investigation) is required</a><br>
			</div>
			</td>
		</tr>
	</table>
