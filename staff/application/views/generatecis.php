...
echo '<table class="tableInfo">';
	...
	if( $row->preparedby != $this->user->empID ){
		...
		echo '<tr><td>Signed Document</td><td><a href="'.$this->config->base_url().'attachment.php?u='.urlencode($this->textM->encryptText('CIS')).'&f='.urlencode($this->textM->encryptText($row->signedDoc)).'" class="iframe"><img src="'.$this->config->base_url().'css/images/pdf-icon.png"/></a><input type="hidden" value="1" id="signed"/></td></tr>';		
		}else{
