...
class MyCrons extends CI_Controller {
	...
	function thisisatest(){
		$hremail = 'this is a test. manila time today is: '.date('Y-m-d H:i:s');
		$this->staffM->sendEmail( 'careers.cebu@tatepublishing.net', 'ludivina.marinas@tatepublishing.net', 'Thisisatest', $hremail, 'CAREERPH' );
	}
