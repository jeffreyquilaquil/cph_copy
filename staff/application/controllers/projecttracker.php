...
class Projecttracker extends MY_Controller {
	...
	public function checkStaff(){
		...
		$empID = $this->dbmodel->getSingleField('staffs', 'empID', 'office="PH-Cebu" AND username="'.$segment3.'"');
		if(!empty($empID)){
			echo 'exist';
		}		
	}
	...
	public function getUserNotes(){
		...
		$notes = array();
		$empID = $this->dbmodel->getSingleField('staffs', 'empID', 'username="'.$cphUser.'"');
		if($empID!=''){
