...
class Emailmodel extends CI_Model {
	...
	***/
	...
	public function sendEvaluationEmail($userType, $staff_id, $evaluator_id, $evaluation_id, $cc=''){
	 	...
	 	$staff_info = $this->databasemodel->getSingleField('staffs',$fields,'empId='.$staff_id);
	 	$evaluator_info = $this->databasemodel->getSingleField('staffs',$fields,"empId=".$evaluator_id);
